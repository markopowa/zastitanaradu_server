...
TEMPLATE_FIELDS = [
    ("employee.first_name", "Ime zaposlenog", TemplateFieldDefinition.CATEGORY_EMPLOYEE),
    ("employee.last_name", "Prezime zaposlenog", TemplateFieldDefinition.CATEGORY_EMPLOYEE),
    ("employee.org_unit", "Organizaciona jedinica", TemplateFieldDefinition.CATEGORY_EMPLOYEE),
    ("employee.position", "Pozicija", TemplateFieldDefinition.CATEGORY_EMPLOYEE),
    ("employee.email", "Email zaposlenog", TemplateFieldDefinition.CATEGORY_EMPLOYEE),
    ...
    ("employee.date_of_birth", "Datum rođenja", TemplateFieldDefinition.CATEGORY_EMPLOYEE),
    ("employee.place_of_birth", "Mesto rođenja", TemplateFieldDefinition.CATEGORY_EMPLOYEE),
    ...
    ("equipment.name", "Naziv opreme/mašine", TemplateFieldDefinition.CATEGORY_EQUIPMENT),
    ("equipment.category", "Kategorija opreme", TemplateFieldDefinition.CATEGORY_EQUIPMENT),
    ("equipment.inventory_number", "Inventarski broj", TemplateFieldDefinition.CATEGORY_EQUIPMENT),
    ("equipment.location", "Lokacija opreme", TemplateFieldDefinition.CATEGORY_EQUIPMENT),
    ...
    ("client.address", "Adresa firme", TemplateFieldDefinition.CATEGORY_CLIENT_COMPANY),
    ...
    ("client.website", "Web sajt firme", TemplateFieldDefinition.CATEGORY_CLIENT_COMPANY),
    ("client.registration_number", "Matični broj", TemplateFieldDefinition.CATEGORY_CLIENT_COMPANY),
    ("client.activity_code", "Šifra delatnosti", TemplateFieldDefinition.CATEGORY_CLIENT_COMPANY),
    ...
    ("client.risk_assessment_act_date", "Datum donošenja Akta o proceni rizika",
     TemplateFieldDefinition.CATEGORY_CLIENT_COMPANY),
    ("scheduled_for", "Datum zakazivanja", TemplateFieldDefinition.CATEGORY_PROCESS),
    ...
    ("process_type_name", "Vrsta obaveze", TemplateFieldDefinition.CATEGORY_PROCESS),
    ("instruction_number", "Broj uputa", TemplateFieldDefinition.CATEGORY_PROCESS),
    ("last_exam_date", "Datum prethodnog pregleda", TemplateFieldDefinition.CATEGORY_PROCESS),
