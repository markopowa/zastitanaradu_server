...
export const TEST_FLOW_PHASES: TestFlowPhase[] = [
    ...
    {
        id: "02_predpodesavanje",
        title: "02 — Predpodešavanje",
        description: "Katalog (seed) + admin ekrani",
    },
    {
        id: "03_unos_firme",
        title: "03 — Unos firme",
...
export const TEST_FLOW_SECTIONS: TestFlowSectionMeta[] = [
    {
        id: "G0",
        phaseId: "02_predpodesavanje",
        label: "Kategorija dokumenta",
        hint: "Dokumenti → Kategorije → Dodaj → Popuni → Sačuvaj",
