...
- [ ] **Šabloni dokumenata: 7** — Uput prethodni, Uput periodični, Obrazac 6, Revers LZO, Potvrda čl. 5, Obrazac 1, Registar RM. Obrazac 6 / Revers se pune iz podataka radnog mesta; potvrda čl. 5 iz blanka na vrsti obuke.
- [ ] **Polja/tagovi** po potrebi šablona (employee/client/equipment/proces).
...
- [ ] Radna mesta sa nivoima rizika + procena rizika + LZO
- [ ] Vrste obuka firme + blanko potvrde
- [ ] Obavezna dokumentacija + Akt + stručni nalazi
- [ ] Upitnik-link za klijenta (Lična karta)
- [ ] Test režim mejlova (Admin) — uključen dok firma nije spremna za prave mejlove
