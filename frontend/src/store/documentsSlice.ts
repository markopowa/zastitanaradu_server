...
export const updateDocumentCategory = createAsyncThunk(
    ...
    async (
        { id, ...payload }: { id: number; code: string; name: string; description?: string },
        { rejectWithValue, dispatch },
    ) => {
        try {
...
export const createDocument = createAsyncThunk(
    ...
    async (
        ...
        try {
            ...
            if (payload.valid_from != null) form.append("valid_from", payload.valid_from);
            if (payload.valid_until != null) form.append("valid_until", payload.valid_until);
            if (payload.version != null) form.append("version", payload.version);
            if (payload.language != null) form.append("language", payload.language);
