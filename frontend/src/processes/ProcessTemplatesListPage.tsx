                    ...
                    <DialogContent>
                                ...
                                <Switch
                                    ...
                                    onChange={(e) =>
                                        this.setState({
                                            form_generate_document:
                                                e.target.checked,
                                            form_attach_generated_document: e
                                                .target.checked
                                                ? this.state
                                                      .form_attach_generated_document
                                                : false,
                                        ...
                                        this.setState({
                                            ...
                                            form_attach_generated_document: e
                                                ...
                                                ? this.state
                                                      .form_attach_generated_document
                                                : false,
                                            form_attach_uploaded_documents: e
                                                .target.checked
                                                ? this.state
                                                      .form_attach_uploaded_documents
                                                : false,
                        ...
                        {form_send_email && form_generate_document && (
                            <FormControlLabel
                                control={
                                    <Switch
                                        checked={form_attach_generated_document}
                                        onChange={(e) =>
                                            this.setState({
                                                form_attach_generated_document:
                                                    e.target.checked,
                        ...
                        {form_send_email && (
                            <FormControlLabel
                                control={
                                    <Switch
                                        checked={form_attach_uploaded_documents}
                                        onChange={(e) =>
                                            this.setState({
                                                form_attach_uploaded_documents:
                                                    e.target.checked,
...
const mapDispatchToProps = (dispatch: AppDispatch): DispatchProps => ({
    ...
    reloadProcessTypes: () => {
        void dispatch(fetchProcessTypes());
    },
    ensureProcessDocTemplates: () => {
